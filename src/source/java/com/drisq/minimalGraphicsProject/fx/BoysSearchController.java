...
public class BoysSearchController implements DrisqController {
	...
	public static BoysSearchController newInstance(Window owner, String title) {
		Stage stage = FxUtil.newStage(owner, FXML_RSC, BoysSearchController.class, title);
		return (BoysSearchController) FxUtil.getController(stage.getScene().getRoot());
	}
